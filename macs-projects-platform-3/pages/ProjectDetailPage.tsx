  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#050B14] text-white">
        ...
        <Link to="/projects" className="text-blue-400 hover:underline">Geri Dön</Link>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#050B14] text-slate-200">
      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div className="container mx-auto px-4 h-full flex flex-col justify-end pb-12 relative z-10">
          <Link to="/" className="absolute top-8 left-4 md:left-0 flex items-center gap-2 text-gray-300 hover:text-white bg-black/30 backdrop-blur-md px-4 py-2 rounded-full transition-all hover:bg-black/50">
            <ArrowLeft size={18} />
      ...
      <div className="container mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <section>
            ...
            <div className="bg-macs-card/50 p-8 rounded-3xl border border-white/5 text-lg leading-relaxed text-gray-300 shadow-xl">
        ...
        <div className="space-y-8">
          ...
          {/* Metadata Card */}
          <div className="bg-macs-card/80 p-6 rounded-3xl border border-white/5 shadow-lg">
