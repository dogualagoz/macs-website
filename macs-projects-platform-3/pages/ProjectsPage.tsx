...
const ProjectsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<ProjectTab>('developed');
  ...
  const featuredProject = PROJECTS.find(p => p.featured && p.tab === activeTab) || filteredProjects[0];
  const gridProjects = filteredProjects.filter(p => p.id !== featuredProject?.id);

  const categories: (ProjectCategory | 'All')[] = ['All', 'Web', 'Mobil', 'Yapay Zeka', 'Oyun', 'Veri Bilimi'];

  const TabButton = ({ id, label, icon: Icon }: { id: ProjectTab; label: string; icon: any }) => (
    <button
      onClick={() => {
        setActiveTab(id);
  ...
  return (
    <div className="min-h-screen bg-[#050B14] text-white overflow-x-hidden relative">
      {/* Background Decor */}
      <div className="absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-blue-900/20 to-transparent pointer-events-none" />
      <div className="absolute top-20 right-20 w-96 h-96 bg-blue-600/10 rounded-full blur-[100px] pointer-events-none animate-pulse-slow" />
      <div className="absolute top-40 left-10 w-72 h-72 bg-purple-600/10 rounded-full blur-[80px] pointer-events-none animate-pulse-slow" />
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="hidden lg:block lg:col-span-3 space-y-8 sticky top-24 h-fit">
            <div className="bg-macs-card/50 backdrop-blur-md rounded-3xl p-6 border border-white/5">
          ...
          <div className="col-span-1 lg:col-span-6 space-y-8">
            ...
            <div className="lg:hidden bg-macs-card/50 backdrop-blur-md rounded-2xl p-4 border border-white/5 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {gridProjects.length > 0 ? (
                ...
                <div className="col-span-full text-center py-12 text-gray-500 bg-macs-card/30 rounded-3xl border border-white/5">
                  Proje bulunamadı.
                </div>
              )}
            </div>
          ...
          <div className="col-span-1 lg:col-span-3 space-y-6">
            <div className="sticky top-24 space-y-6">
              ...
              {/* Leaderboard Card */}
              <div className="bg-macs-card/50 backdrop-blur-md rounded-3xl border border-white/5 overflow-hidden">
                ...
                <div className="p-4 space-y-4">
                  {USERS.sort((a, b) => b.projectCount - a.projectCount).slice(0, 5).map((user, idx) => (
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-6 text-center relative overflow-hidden shadow-lg group">
                ...
                <div className="relative z-10">
                  <Rocket className="mx-auto mb-3 text-white/80 group-hover:animate-float" size={40} />
