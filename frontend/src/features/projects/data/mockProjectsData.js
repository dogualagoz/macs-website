/**
 * Mock Data for Projects Platform
 * Temporary data source until backend integration is complete
 */
...
export const MOCK_PROJECTS = [
  {
    ...
    imageUrl: '/assets/images/projects/sentinel-ai-terminal.webp',
    category: 'Yapay Zeka',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/projects/codabrate-web.webp',
    category: 'Web',
    tags: ['Next.js', 'React', 'Tailwind', 'Supabase', 'PostgreSQL'],
    status: 'Geliştirme Aşamasında',
    date: '20 Aralık 2023',
    team: [MOCK_USERS[1], MOCK_USERS[4]],
  ...
  },
  {
    ...
    imageUrl: '/assets/images/projects/endless-zombie-cover.webp',
    category: 'Oyun',
  ...
  },
  {
    ...
    imageUrl: '/assets/images/projects/macs-menu-otopilotu.webp',
    category: 'Yapay Zeka',
  ...
  },
  {
    ...
    status: 'Geliştirme Aşamasında',
    date: '05 Şubat 2024',
    team: [MOCK_USERS[0], MOCK_USERS[2], MOCK_USERS[4]],
    tab: 'supported'
  },
  {
    id: 'kisisel-blog',
...
export const PROJECT_CATEGORIES = ['All', 'Web', 'Mobil', 'Yapay Zeka', 'Oyun', 'Veri Bilimi'];
